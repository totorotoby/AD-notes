...
\node[squarednode] (v1) at (-4,-2) {$\pd{y}{v_1} = \pd{y}{y_1}\pd{v_5}{v_1} = -\pd{y}{y_1}$};
...
\node[squarednode] (x1) at (-4,-.5) {$\pd{y}{x_1} = \pd{y}{v_5}\pd{v_5}{v_1} = -\pd{y}{v_4}$};

\node[roundnode] (v5) at (3.75, -6) {$\pd{y}{y_1}$};

%\node[roundnode] (y1) at (3.75,-7.5) {$\pd{y}{y_1}$};
